              ...
              >
                ...
                <div className="md:hidden space-y-4">
                  ...
                  <div className="flex gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {item.discount?.isActive && (
                        <span className="inline-block text-xs font-medium text-brand bg-brand/10 px-2 py-1 rounded mb-2">
                  ...
                  <button
                    ...
                    className="w-full text-center text-sm text-brand hover:text-brand-dark transition-colors py-2 border border-brand/30 hover:border-brand rounded-md"
                  >
                    Remove
                  </button>
                </div>
